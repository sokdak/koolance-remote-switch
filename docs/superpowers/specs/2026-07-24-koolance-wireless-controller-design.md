...
| 정상 유지 시간 | 1–60초 | 10초 |
| 후행 운전 | 0–60분 | 5분 |
| 알람 온도 편차 | 1–50°C/°F | 5°C |
| 알람 최소 유량 | 사용 안 함 또는 0.1–20.0 LPM | 1.0 LPM |
| 알람 최소 팬 RPM | 사용 안 함 또는 100–10,000 RPM | 사용 안 함 |
| 알람 최소 펌프 RPM | 사용 안 함 또는 100–10,000 RPM | 1,000 RPM |
| 릴레이 온도 편차 | 1–50°C/°F | 5°C |
| 릴레이 최소 유량 | 사용 안 함 또는 0.1–20.0 LPM | 사용 안 함 |
| 릴레이 최소 팬 RPM | 사용 안 함 또는 100–10,000 RPM | 사용 안 함 |
| 릴레이 최소 펌프 RPM | 사용 안 함 또는 100–10,000 RPM | 사용 안 함 |
| 수위 동작 | 모두 끔, 알람, 릴레이, 모두 켬 | 알람+릴레이 |
| 이슬점 경고 여유 | 0–10°C, 0.5 단위 | +2.0°C |
| 결로 시 동작 | 경보만 | 경보만 |
| 모델 프로파일 | EXC-900, VLX-2000 | 최초 설치 시 필수 입력 |

설정 편집은 `현재값 읽기 → 임시 변경 → 적용 확인 → KSM 쓰기 → 재조회 검증`의 2단계 방식이다. 운전 중 펌프 0단계는 별도 경고와 2초 확인을 요구한다. 프로파일 변경은 PC OFF 상태에서만 허용한다. UI 프로토타입은 위 표의 모든 설정과 페어링, 버저 시험, 진단 화면을 실제 탐색 가능한 형태로 제공한다.
